      ...
      localConfig =
        if builtins.pathExists ./local.nix then
          ...
          builtins.throw ''
            ...
            This file contains machine-specific configuration (username, system, homeDirectory).
            ...
            Then edit local.nix with your values.
          '';

      inherit (localConfig) system username homeDirectory;
